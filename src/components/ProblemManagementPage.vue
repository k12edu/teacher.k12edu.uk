    ...
    methods:{
      ...
      switchToShowPage(item){
        if(this.selectedOption=='program'){
          this.$router.push({ name: 'ProgramProblemEdit', params: { id:item.problem_id,suject:this.selectedOption} ,query:{suject:this.selectedOption}});
        }
        else if(this.selectedOption=='math'){
          this.$router.push({ name: 'MathProblemEdit', params: { id: item.problem_id,suject:this.selectedOption} ,query:{suject:this.selectedOption}});
        }
        else if(this.selectedOption=='science'){
          this.$router.push({ name: 'NaturalProblemEdit', params: { id: item.problem_id,suject:this.selectedOption},query:{suject:this.selectedOption}});
        }
      },
      checkScreenSize() {
